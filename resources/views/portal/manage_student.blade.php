                        ...
                        <div class="btn-group">
                          <button type="button" class="btn btn-warning"  onclick="edit_Rec({{json_encode($data)}})"   data-toggle="modal" data-target="#modal-Edit"  name="edit-btn" title="edit btn" >
                            <img src="/assets/svg/edit-btn.svg"  class="img-fluid"/></button>
                                 <form  action="/portal/delete_student/{{$data->id}}" method="post"  onsubmit="return del_Rec()">
                                  {{ method_field('delete') }}
                                  @csrf
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form  action="/portal/add_manage_student" method="post" >
               @csrf
...
function edit_Rec(data)
{
  ...
  document.getElementById("edit_action").action= "/portal/edit_manage_student/"+data['id'];
